...
@section('content')
   <div class="container">
    <ul class="sort-btn">
        ...
        <li role="button" class="btn btn-light" style="background-color: darkgray; color: white;"><a href="{{ route('admin.museum.add') }}"><span class="text-decoration-none">新規追加</span></a></li>
    </ul>
</div>
</ul>
 <ul class="grid">
